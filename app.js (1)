...
/* =================================================================
   4. WEAPON RIGS (RIFLE, KARAMBIT, SHERIFF PISTOL)
   ================================================================= */
...
// SHERIFF PISTOL RIG (WITH UNIQUE PULL-OUT & CYLINDER ANIMATION GROUP)
...
let currentWeapon = 'rifle'; // 'rifle', 'knife', 'sheriff'
let isScoped = false;
let isCrouching = false;
let reloadAnimProgress = 0;
let equipAnimProgress = 1.0; // For unique pull-out animation
...
function setWeapon(type) {
  ...
  // Trigger unique pull-out / equip animation
...
// 3-Way Weapon Cycle (Rifle -> Sheriff -> Knife -> Rifle)
...
const SHERIFF_FIRE_DELAY = 220; // Slower semi-auto fire rate for Sheriff
...
/* =================================================================
   9. ATTACK SYSTEM, SHERIFF DAMAGE (1-TAP HEAD, 3-TAP BODY, 4-5 TAP LEGS)
   ================================================================= */
...
function calculateShotDamage(hitObject, hitPoint, targetMesh) {
  ...
  if (currentWeapon === 'sheriff') {
    // Sheriff Damage: 1-Tap Headshot (100+ DMG), 3-Tap Body (34 DMG), 4-5 Tap Legs (22 DMG)
...
function executeSingleShot() {
  ...
  if (currentWeapon === 'sheriff') {
    // Sheriff: First 2 bullets accurate, slight recoil on subsequent shots
...
/* =================================================================
   11. MAIN ENGINE LOOP & ANIMATIONS
   ================================================================= */
...
function animate(time) {
  ...
  // Equip animation & reload dip interpolation
